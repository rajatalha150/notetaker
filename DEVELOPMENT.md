...
- Desktop now attempts deterministic native participant detection from live process/window metadata and UI automation first, source titles second, and records those names separately from manual fallback hints.
