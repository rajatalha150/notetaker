...
- Desktop now attempts deterministic native participant detection from live source/window titles and records those names separately from manual fallback hints.
- Remaining parity work is focused on deeper native-app integrations beyond title parsing and any future true cross-app library sync.
